...
Report bugs at <https://github.com/florean/python-template/issues
...
The best way to send feedback is to file an issue at <https://github.com/florean/python-template/issues.
...
git clone git@github.com:YOUR_NAME/python-template.git
```
