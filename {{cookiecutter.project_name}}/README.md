...
To finalize the set-up for publishing to PyPI, see [here](https://florean.github.io/python-template/features/publishing/#set-up-for-pypi).
For activating the automatic documentation with MkDocs, see [here](https://florean.github.io/python-template/features/mkdocs/#enabling-the-documentation-on-github).
To enable the code coverage reports, see [here](https://florean.github.io/python-template/features/codecov/).
...
For more details, see [here](https://florean.github.io/python-template/features/cicd/#how-to-trigger-a-release).
{%- endif %}

---

Repository initiated with [florean/python-template](https://github.com/florean/python-template).
